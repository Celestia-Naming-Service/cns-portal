...
const sidebarNavigation = [
  ...
  { name: "Domains", href: "#", icon: Squares2X2Icon, current: false },
    ...
    <>
      ...
      */}
      <div className="flex h-full">
        {/* Narrow sidebar */}
        <div className="hidden w-28 overflow-y-auto bg-slate-700 md:block">
          <div className="flex w-full flex-col items-center py-6">
            <div className="flex flex-shrink-0 items-center">
              <span className="text-white text-2xl">CNS</span>
            </div>
