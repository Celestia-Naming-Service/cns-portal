...
function AddNetworkKeplr({ params, setKeplr }: AddNetworkKeplrProps): React.FC {
  function KeplrComponentAddWallet() {
    ...
    return (
      <div>
        <button
          className=" flex w-full justify-center rounded-md border border-transparent bg-sky-600 py-2 px-4 text-sm font-medium text-white shadow-sm hover:bg-sky-700 focus:outline-none focus:ring-2 focus:ring-sky-500 focus:ring-offset-2 mt-5"
          onClick={add}
          type="button"
        >
